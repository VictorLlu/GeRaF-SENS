...
#include "signal_tracer/SignalTracer.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, module) {
  ...
  module.def(
      "SignalTracer_forward",
      &SignalTracer_forward,
      "Run the retained differentiable CUDA signal tracer.");
  module.def(
      "SignalTracer_backward_normal_sigma",
      &SignalTracer_backward_normal_sigma,
      "Backpropagate signal-tracer gradients into normals and sigma values.");
  module.def(
      "BilinearRaysample_forward",
      &BilinearRaysample_forward,
      "Interpolate normals and sigmas along ray depth samples.");
  module.def(
      "BilinearRaysample_backward",
      &BilinearRaysample_backward,
      "Backpropagate through the bilinear ray-depth interpolation kernel.");
}
